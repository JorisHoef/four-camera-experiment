...
#region Unity Methods
        ...
        private void Update()
        {
            ...
            bool sprint =
                    _enableSprint
                 && IsSprintHeld(); // && _cc.isGrounded; TODO: Will probably stop velocity while in a jump.
            bool jumpPressed = _enableJump && IsJumpPressed();

            //TODO: Check why it's called wish direction
            Vector3 wishDir = ComputeWishDirection(moveInput);
            float speed = sprint ? _moveSpeed * _sprintMultiplier : _moveSpeed;
